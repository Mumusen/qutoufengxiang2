        ...
        <table>
            ...
            <tbody v-if="stockListTable && stockListTable.length !== 0" v-for="stock in stockListTable" style="background: #fff;border-right: 1px solid #dedede;border-bottom: 1px solid #dedede">
                <tr >
                    ...
                    <td> 
                        <router-link 
                            :to="'/stockDetails?name='+stock.oneData.secu_abbr+'&code='+stock.oneData.stockCode"
                        >
                ...
                <tr v-for="differ in stock.data">
                    ...
                    <td><router-link 
                            :to="'/stockDetails?name='+differ.secu_abbr+'&code='+differ.stockCode"
                        >{{differ.secu_abbr}}</router-link ></td>
