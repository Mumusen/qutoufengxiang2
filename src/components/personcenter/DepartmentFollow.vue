...
export default {
    ...
    computed: {
        ...mapGetters(['personFollowDepartment'])
    },
    ...
    methods: {
        ...
        changePage(val){
            ...
            this.getPersonFollowDepartment({no: val});
        },
        ...
        handleDeleteDepartment(id){
            // console.log(id);
            this.personDeleteDepartment({infoToken: id});

            // setTimeout(()=>{
            this.getPersonFollowDepartment({no: this.currentPage});
            // }, 100);
        },
