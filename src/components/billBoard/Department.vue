...
<div>
    ...
    <div class="departmentBusiness">
        ...
        <div class="chartContainer" v-if="stockDetails.dates">
            <div :style="{opacity: buyIsShow}" class="buyDepart" >
                <div class="chartArea">
                    <div class="chart-l">
                ...
                <div class="chartDesc">
                    <ul v-if="stockDetail_billboard && stockDetail_billboard.buys">
                        <li  
                            v-for="(buy,index) in stockDetail_billboard.buys" 
                            @click="jumpDepartmentDetail({
                                id: buy.boCode
                            })">
            ...
            <div :style="{opacity: sellIsShow}" class="sellDepart">
                <div class="chartArea">
                    <div class="chart-l">
                ...
                <div class="chartDesc">
                    <ul v-if="stockDetail_billboard && stockDetail_billboard.sales">
                        <li v-for="(sale, index) in stockDetail_billboard.sales"
                            @click="jumpDepartmentDetail({
                                id: sale.boCode
                            })">
    ...
    watch: {
       'stockDetails.dates'(newVal, oldVal){
        ...
        'stockDetail_billboard'(newVal, oldVal){
            if(newVal){
                this.calNetData({
                    operData: this.stockDetail_billboard.buys?this.stockDetail_billboard.buys:[],
                    type: 'buy'
                });
                this.calNetData({
                    operData: this.stockDetail_billboard.sales?this.stockDetail_billboard.sales:[],
                    type: 'sale'
                })
            }
        }
