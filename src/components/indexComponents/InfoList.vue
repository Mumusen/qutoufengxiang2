...
<div>
    <div class="ThemeList" v-if="indexInfomation">
        <div v-for="(info,index) in indexInfomation" class="dayContainer">
            
            <div v-if="!info.date.isSame" class="flag">
                <span>{{info.date.month }}月</span>
            ...
            <div class="row" style="margin:0;">
                <div class="col col-md-11 col-md-offset-1 unit">
                    ...
                    <div class="themeArea">
                        ...
                        <div class="t-content">
                            <p>
                                <b style="margrin-right: 15px;">{{info.infomationName}}</b>
                                <!-- 120 -->
    ...
    <div class="getMore">
        <span><router-link to="/information">更多</router-link></span>
    </div>
