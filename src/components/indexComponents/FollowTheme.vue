        ...
        <ul class="followContainer">
            <li v-for="followTheme in followThemeList">
                ...
                <div class="follow-r">
                    <div class="t-title">
                        <span>
                            <router-link :to="'/article?id='+followTheme.right.id">
                    ...
                    <div class="t-content">
                        ...
                        ><i></i><b>{{stock.name}}</b><b :class="stock.style">{{stock.value}}</b></span>
...
export default {
    ...
    watch: {
        ...
        'todayFollowTheme'(newVal, oldVal){
            // console.log(newVal);
            this.handleTodayFollowTheme(newVal.todayAttentionInformation);
        }
    },
