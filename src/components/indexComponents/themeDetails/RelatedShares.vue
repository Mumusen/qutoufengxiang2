    ...
    <div class="stocksList" v-for="stock in relationStock" >
        <div class="itemStock">
            ...
            >
                ...
                <span :class="stock.changeRate>=0?'textRed':'textGreen'">{{(stock.currentPrice).toFixed(2)}}</span>
                <span :class="stock.changeRate>=0?'textRed':'textGreen'">
            ...
            <div class="itemContent">
                ...
                <p>{{wordLimit(stock.associateReason)}}</p>
            </div>
